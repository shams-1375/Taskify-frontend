...
import { BACK_BUTTON, FULL_BUTTON, personalFields, SECTION_WRAPPER, INPUT_WRAPPER } from '../assets/dummy'
        ...
        <div className=' min-h-screen  bg-gray-50'>
            ...
            <div className=' max-w-4xl mx-auto p-6'>
                ...
                <div className=' flex items-center gap-4 mb-8'>
                    <div className=' w-16 h-16 rounded-full bg-linear-to-br  from-teal-500  to-cyan-600 flex items-center justify-center  text-white text-2xl font-bold shadow-md'>
                ...
                <div className=' grid md:grid-cols-2 gap-8'>
                    <section className={SECTION_WRAPPER}>
                        <div className=' flex items-center gap-2 mb-6'>
                            <UserCircle className='  text-cyan-500 w-5 h-5' />
