  ...
  return (
    <div className={layoutClasses.container}>
      <div className={layoutClasses.headerWrapper}>
        <div>
          <h1 className=' text-2xl md:text-3xl font-bold text-gray-800 flex items-center gap-2'>
            <ListChecks className=' text-cyan-500' /> Pending Task
          </h1>
      ...
      <div
        ...
        className='hidden md:flex items-center mt-4 justify-center p-4 border-2 border-dashed border-cyan-200 rounded-xl hover:border-cyan-400 bg-cyan-50/50 cursor-pointer transition-colors'>
